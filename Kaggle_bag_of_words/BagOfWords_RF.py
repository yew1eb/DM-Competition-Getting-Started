...
if __name__ == '__main__':
    ...
    for i in range(0,len(test["review"])):
        clean_test_reviews.append(" ".join(KaggleWord2VecUtility.review_to_wordlist(test["review"][i], False)))
    ...
    output.to_csv('out/Bag_of_Words_model_RF.csv', index=False, quoting=3)
    print("Wrote results to Bag_of_Words_model_RF.csv")
